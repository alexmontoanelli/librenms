...
if (preg_match('/cdr/', strtolower($graph_data['bill_type']))) {
    ...
    //conforme o lado que bilhetou o percentil, inverte a linha no grafico
    $pDir = ($graph_data['dir_95th'] == 'out') ? $graph_data['rate_95th'] * -1 : $graph_data['rate_95th'];

    $lineplot_95th = new LinePlot([$pDir, $pDir], [$xmin, $xmax]);
